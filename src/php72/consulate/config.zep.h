...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_consulate_config_newdefaultconfig, 0, 0, Consulate\\Config, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_config_newdefaultconfig, 0, 0, IS_OBJECT, "Consulate\\Config", 0)
#endif
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_config_durtomsec, 0, 1, IS_STRING, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_config_durtomsec, 0, 1, IS_STRING, NULL, 0)
#endif
#if PHP_VERSION_ID >= 70200
	ZEND_ARG_TYPE_INFO(0, dur, IS_LONG, 0)
#else
	ZEND_ARG_INFO(0, dur)
#endif
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_config_getdefaultconfig, 0, 0, IS_ARRAY, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_config_getdefaultconfig, 0, 0, IS_ARRAY, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(consulate_config_method_entry) {
	...
	PHP_ME(Consulate_Config, newDefaultConfig, arginfo_consulate_config_newdefaultconfig, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Consulate_Config, getDefaultConfig, arginfo_consulate_config_getdefaultconfig, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC)
	PHP_FE_END
};
