...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_http_auth_compileauthstring, 0, 0, IS_STRING, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_http_auth_compileauthstring, 0, 0, IS_STRING, NULL, 0)
#endif
ZEND_END_ARG_INFO()

#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_http_auth___tostring, 0, 0, IS_STRING, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_http_auth___tostring, 0, 0, IS_STRING, NULL, 0)
#endif
ZEND_END_ARG_INFO()

#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_http_auth_jsonserialize, 0, 0, IS_ARRAY, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_consulate_http_auth_jsonserialize, 0, 0, IS_ARRAY, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(consulate_http_auth_method_entry) {
	...
	PHP_ME(Consulate_Http_Auth, compileAuthString, arginfo_consulate_http_auth_compileauthstring, ZEND_ACC_PUBLIC)
	PHP_ME(Consulate_Http_Auth, __toString, arginfo_consulate_http_auth___tostring, ZEND_ACC_PUBLIC)
	PHP_ME(Consulate_Http_Auth, jsonSerialize, arginfo_consulate_http_auth_jsonserialize, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
