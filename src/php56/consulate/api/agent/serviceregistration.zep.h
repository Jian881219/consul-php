...
ZEND_BEGIN_ARG_INFO_EX(arginfo_consulate_api_agent_serviceregistration_setcheck, 0, 0, 1)
	ZEND_ARG_OBJ_INFO(0, check, Consulate\\Api\\Agent\\ServiceCheck, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_consulate_api_agent_serviceregistration_setchecks, 0, 0, 1)
